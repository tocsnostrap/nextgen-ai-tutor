...
gen_videos_dir = os.path.join(os.path.dirname(__file__), "..", "attached_assets", "generated_videos")
os.makedirs(gen_videos_dir, exist_ok=True)
app.mount("/generated-videos", StaticFiles(directory=gen_videos_dir), name="generated_videos")
